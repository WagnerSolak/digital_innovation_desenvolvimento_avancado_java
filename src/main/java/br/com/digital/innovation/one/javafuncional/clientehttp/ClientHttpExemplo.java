package br.com.digital.innovation.one.javafuncional.clientehttp;
...
public class ClientHttpExemplo {
    ...
    static ExecutorService executor = Executors.newFixedThreadPool(6, new ThreadFactory() {
        ...
        public Thread newThread(Runnable runnable) {
            ...
            System.out.println("Nova thread criada :: "
                    +(thread.isDaemon() ? "daemon" : "") +"ThreadGroup ::"
    ...
    private static void connectAkamaiHttp11Client() throws Exception {
        ...
        try {
            ...
            long start = System.currentTimeMillis();// p/ acompanhar performance da req
    ...
    private static void connectAndPrintURLJavaOracle() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder() //newBuilder da a instacia dele
                .GET().uri(URI.create("https://docs.oracle.com/javase/10/language/"))
                .build();

        HttpClient client = HttpClient.newHttpClient(); // responsavel pela execucao
        // no response esta o corpo da resposta
